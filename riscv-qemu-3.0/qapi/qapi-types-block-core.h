...
typedef enum MirrorCopyMode {
    MIRROR_COPY_MODE_BACKGROUND = 0,
    MIRROR_COPY_MODE_WRITE_BLOCKING = 1,
    MIRROR_COPY_MODE__MAX = 2,
} MirrorCopyMode;
...
typedef enum BlockdevDriver {
    ...
    BLOCKDEV_DRIVER_BLKLOGWRITES = 1,
    BLOCKDEV_DRIVER_BLKVERIFY = 2,
    BLOCKDEV_DRIVER_BOCHS = 3,
    BLOCKDEV_DRIVER_CLOOP = 4,
    BLOCKDEV_DRIVER_COPY_ON_READ = 5,
    BLOCKDEV_DRIVER_DMG = 6,
    BLOCKDEV_DRIVER_FILE = 7,
    BLOCKDEV_DRIVER_FTP = 8,
    BLOCKDEV_DRIVER_FTPS = 9,
    BLOCKDEV_DRIVER_GLUSTER = 10,
    BLOCKDEV_DRIVER_HOST_CDROM = 11,
    BLOCKDEV_DRIVER_HOST_DEVICE = 12,
    BLOCKDEV_DRIVER_HTTP = 13,
    BLOCKDEV_DRIVER_HTTPS = 14,
    BLOCKDEV_DRIVER_ISCSI = 15,
    BLOCKDEV_DRIVER_LUKS = 16,
    BLOCKDEV_DRIVER_NBD = 17,
    BLOCKDEV_DRIVER_NFS = 18,
    BLOCKDEV_DRIVER_NULL_AIO = 19,
    BLOCKDEV_DRIVER_NULL_CO = 20,
    BLOCKDEV_DRIVER_NVME = 21,
    BLOCKDEV_DRIVER_PARALLELS = 22,
    BLOCKDEV_DRIVER_QCOW = 23,
    BLOCKDEV_DRIVER_QCOW2 = 24,
    BLOCKDEV_DRIVER_QED = 25,
    BLOCKDEV_DRIVER_QUORUM = 26,
    BLOCKDEV_DRIVER_RAW = 27,
    BLOCKDEV_DRIVER_RBD = 28,
    BLOCKDEV_DRIVER_REPLICATION = 29,
    BLOCKDEV_DRIVER_SHEEPDOG = 30,
    BLOCKDEV_DRIVER_SSH = 31,
    BLOCKDEV_DRIVER_THROTTLE = 32,
    BLOCKDEV_DRIVER_VDI = 33,
    BLOCKDEV_DRIVER_VHDX = 34,
    BLOCKDEV_DRIVER_VMDK = 35,
    BLOCKDEV_DRIVER_VPC = 36,
    BLOCKDEV_DRIVER_VVFAT = 37,
    BLOCKDEV_DRIVER_VXHS = 38,
    BLOCKDEV_DRIVER__MAX = 39,
} BlockdevDriver;
...
typedef enum RbdAuthMode {
    RBD_AUTH_MODE_CEPHX = 0,
    RBD_AUTH_MODE_NONE = 1,
    RBD_AUTH_MODE__MAX = 2,
} RbdAuthMode;
