...
void visit_type_BlockDirtyBitmapAdd_members(Visitor *v, BlockDirtyBitmapAdd *obj, Error **errp)
{
    ...
    if (visit_optional(v, "x-disabled", &obj->has_x_disabled)) {
        visit_type_bool(v, "x-disabled", &obj->x_disabled, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockDirtyBitmapMerge_members(Visitor *v, BlockDirtyBitmapMerge *obj, Error **errp)
{
    ...
    visit_type_str(v, "dst_name", &obj->dst_name, &err);
    if (err) {
        goto out;
    }
    visit_type_str(v, "src_name", &obj->src_name, &err);
    if (err) {
        goto out;
    }
